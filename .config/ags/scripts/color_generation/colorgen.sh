...
if [[ "$1" = "#"* ]]; then # this is a color
    ...
    if [ "$2" = "--apply" ]; then
        cp "$CACHE_DIR"/user/generated/material_colors.scss "$XDG_STATE_DIR/scss/_material.scss"
    ...
    if [ "$2" = "--apply" ]; then
        sass -I "$STATE_DIR/scss" -I "$CONFIG_DIR" "$CACHE_DIR"/user/generated/material_colors.scss "$CACHE_DIR"/user/generated/colors_classes.scss --style compact
        ...
        cp "$CACHE_DIR"/user/generated/colors_classes.scss "$XDG_STATE_DIR/scss/_material.scss"
